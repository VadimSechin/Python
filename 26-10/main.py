...
screen_width, screen_height = space = (800, 600)
number_of_balls = 4
super_ball_possibility = 40  # in percent
targets_speed = 2
...
def draw_balls():
    ...
    for super_ball in super_balls:
        ...
        circle(screen, super_ball[0][2], (super_ball[1], super_ball[2]), super_ball[3] - 20)
